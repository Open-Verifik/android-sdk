...
public class PhotoIDScanProcessor extends Processor implements FaceTecIDScanProcessor {
    ...
    public PhotoIDScanProcessor(Context context,
                                String sessionToken,
                                String verifikToken,
    ...
    public void processIDScanWhileFaceTecSDKWaits(final FaceTecIDScanResult idScanResult, final FaceTecIDScanResultCallback idScanResultCallback) {
        ...
        if(idScanResult.getStatus() != FaceTecIDScanStatus.SUCCESS) {
            verifikCallback.photoIDScanError("User cancel Photo ID Scan or there was a connection error");
        ...
        try {
            ...
            if(externalDatabaseRefID != null &&
                    !externalDatabaseRefID.equals("")) {
                parameters.put("externalDatabaseRefID",externalDatabaseRefID);
            }
        }
        catch(JSONException e) {
            e.printStackTrace();
            verifikCallback.photoIDScanError("Photo Scan parameters exception");
        ...
        okhttp3.Request request = new okhttp3.Request.Builder()
                .url(VerifikURL.Base + VerifikURL.IDScan)
        ...
        NetworkingHelpers.getApiClient().newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull okhttp3.Response response) throws IOException {
                ...
                try {
                    ...
                    if(responseJSON.has("code") ||
                        ...
                        verifikCallback.photoIDScanError(err);
                        idScanResultCallback.cancel();
                        return;
                    }
                    ...
                    if(wasProcessed) {
                        ...
                        verifikCallback.photoIDScanError("Can't scan ID");
                        idScanResultCallback.cancel();
                    }
                }
                catch(JSONException e) {
                    ...
                    e.printStackTrace();
                    verifikCallback.photoIDScanError("There was an error parsing ID scan resulting data, please contact Verifik Support Team");
            ...
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                ...
                verifikCallback.photoIDScanError("There was an error parsing ID scan resulting data 2, please contact Verifik Support Team");
