...
public class AuthenticateProcessor extends Processor implements FaceTecFaceScanProcessor {
    ...
    public AuthenticateProcessor(Context context, String sessionToken,
    ...
    public void processSessionWhileFaceTecSDKWaits(final FaceTecSessionResult sessionResult, final FaceTecFaceScanResultCallback faceScanResultCallback) {
        ...
        if(sessionResult.getStatus() != FaceTecSessionStatus.SESSION_COMPLETED_SUCCESSFULLY) {
            verifikCallback.authError("User cancel authentication or there was a connection error");
        ...
        try {
            ...
            e.printStackTrace();
            verifikCallback.authError("Enrollment parameters exception");
        ...
        okhttp3.Request request = new okhttp3.Request.Builder()
                .url(VerifikURL.Base + VerifikURL.Authenticate)
        ...
        NetworkingHelpers.getApiClient().newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull okhttp3.Response response) throws IOException {
                ...
                try {
                    ...
                    if(responseJSON.has("code") &&
                        ...
                        verifikCallback.authError("User not found on database");
                        faceScanResultCallback.cancel();
                        return;
                    }
                    if(responseJSON.has("code") &&
                            responseJSON.getString("code").equals("Conflict")){
                        verifikCallback.authError("Biometric is disabled");
                        faceScanResultCallback.cancel();
                        return;
                    }
                    if(responseJSON.has("code") ||
                    ...
                    if(wasProcessed) {
                        ...
                        verifikCallback.authError("No authorization granted");
                        faceScanResultCallback.cancel();
                    }
                }
                catch(JSONException e) {
                    ...
                    e.printStackTrace();
                    verifikCallback.authError("There was an error parsing authentication resulting data, please contact Verifik Support Team");
            ...
            public void onFailure(@NonNull Call call, IOException e) {
                ...
                verifikCallback.authError("There was an error parsing authentication resulting data 2, please contact Verifik Support Team");
